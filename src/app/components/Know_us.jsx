...
//             {
//               icon: (
//                 <FaBagShopping className="h-7 w-7 md:h-9 md:w-9 text-blue-500" />
//               ),
//               title: "Fair Prices",
...
//             {
//               icon: (
//                 <IoIosPeople className="h-9 w-9 md:h-10 md:w-10 text-blue-500" />
//               ),
...
//             },
//             {
//               icon: <FaAward className="h-7 w-7 md:h-8 md:w-8 text-blue-500" />,
//               title: "Award Winning",
//               text: "After we provide full services, we have received very good reviews from clients, which we feel is like an Award",
//               delay: 600,
//             },
//             {
//               icon: <FiClock className="h-7 w-7 md:h-8 md:w-8 text-blue-500" />,
//               title: "24/7 Support",
...
//           ].map((item, index) => (
//             <div
//             className="flex gap-4 mt-0 group p-3 rounded-lg transition-all duration-300"
//             key={index}
//             data-aos="fade-right"
...
//               {React.cloneElement(item.icon, { className: "h-7 w-7 md:h-9 md:w-9 text-blue-500 group-hover:text-white transition-all duration-300" })}
//             </div>
//             <div>
...
//         >
//           <img src="https://cloudbookingsolutions.com/img/about-extra-1.svg" alt="Cloud Booking" />
//         </div>
...
//             is a Leading Web Development And Digital Marketing Agency. Our Professional Expertise Comprises Skilled And Experienced Designers And Developers Flexible In Creating Solutions According To The Demands.
//           </p>
